...
class GrowRendererTUI {
  components = {
    Container: function () {
      ...
      if (this.children && this.children.length > 0) {
        ...
        const availableWidth =
          (width - marginLeft - marginRight - borderWidth * 2 - paddingLeft - paddingRight) * 10
        const availableHeight =
          (height - marginTop - marginBottom - borderWidth * 2 - paddingTop - paddingBottom) * 10
        ...
        for (const child of this.children) {
          ...
          if (!child.height && child.constructor.name === 'Center') {
            ...
            const remainingHeight =
              (height - childCurrentY - marginBottom - borderWidth - paddingBottom) * 10
    ...
    Center: function () {
      const width = Math.floor((this.width || 0) / 10)
      const height = Math.floor((this.height || 0) / 10)

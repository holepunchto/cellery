...
class GrowRendererTUI {
  components = {
    Container: function () {
      ...
      // Update for passing to child
      // this.width = width - borderWidth * 2 - paddingLeft - marginLeft - paddingRight - marginRight

      // this.width = width - borderWidth * 2 - paddingLeft - paddingRight
      // this.height = height - borderWidth * 2 - paddingTop - paddingBottom
